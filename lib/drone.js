...
/**
 * Instructs the drone to take a picture.
 */
...
function takePicture(options, callback) {
  ...
  this.logger('RollingSpider#takePicture');
  this.writeTo(
    'fa0b',
    new Buffer([0x02, ++this.steps.fa0b & 0xFF, 0x02, 0x06, 0x00, 0x00, 0x00])
  );
  if (callback) {
    callback();
  }
...
// camera
Drone.prototype.takePicture = takePicture;
