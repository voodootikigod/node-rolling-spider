...
/**
 * Starts a regular ping that's sent to the drone every 500 milliseconds.
 *
 * It would seem that this is required.
 *
 * @param callback to be called once the ping is started
 */
RollingSpider.prototype.startPing = function (callback) {
