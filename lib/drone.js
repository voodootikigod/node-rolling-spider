...
Drone.isDronePeripheral = function(peripheral) {
  ...
  var localNameMatch = localName 
    && (localName.indexOf('RS_') === 0 || localName.indexOf('Mars_') === 0 || localName.indexOf('Travis_') === 0);
  var manufacturerMatch = manufacturer 
    && (manufacturer.toString('hex') === '4300cf1900090100' || manufacturer.toString('hex') === '4300cf1909090100' );
