...
Drone.isDronePeripheral = function(peripheral) {
  ...
  var localNameMatch = localName && (localName.indexOf('RS_') === 0 || localName.indexOf('Maclan_') === 0);
  var manufacturerMatch = manufacturer && (manufacturer.toString('hex') === '4300cf1900090100' || manufacturer.toString('hex') === '4300cf1907090100');
