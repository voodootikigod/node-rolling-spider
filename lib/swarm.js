...
Swarm.prototype.isMember = function(peripheral) {
  ...
  if (this.targets.length === 0) {
    ...
    var localNameMatch = localName
      && (localName.indexOf('RS_') === 0 || localName.indexOf('Mars_') === 0 || localName.indexOf('Travis_') === 0  || localName.indexOf('Maclan_')=== 0 || localName.indexOf('NewZ_')=== 0);
    var manufacturerMatch = manufacturer
      && (['4300cf1900090100', '4300cf1909090100', '4300cf1907090100', '4300cf190a090100'].indexOf(manufacturer) >= 0);
